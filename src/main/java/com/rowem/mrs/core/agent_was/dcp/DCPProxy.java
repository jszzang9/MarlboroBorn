package com.rowem.mrs.core.agent_was.dcp;
...
import com.rowem.mrs.MrsConfiguration;
...
public class DCPProxy {
	...
	public static String send(String telegram, String bodyData) throws Exception {
		Socket socket = new Socket(MrsConfiguration.getProperty("dcp.proxy.ip"), Integer.parseInt(MrsConfiguration.getProperty("dcp.proxy.port")));
